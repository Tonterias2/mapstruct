...
export class EducationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.educationService
      ...
      .subscribe(
        (res: HttpResponse<IEducation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInEducations(): void {
    this.eventSubscriber = this.eventManager.subscribe('educationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IEducation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
