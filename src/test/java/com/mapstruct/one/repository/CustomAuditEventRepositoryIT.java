...
import com.mapstruct.one.config.audit.AuditEventConverter;
import com.mapstruct.one.domain.PersistentAuditEvent;
...
import static com.mapstruct.one.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
