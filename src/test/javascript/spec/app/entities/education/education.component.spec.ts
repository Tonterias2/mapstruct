...
import { EducationComponent } from 'app/entities/education/education.component';
...
describe('Component Tests', () => {
  describe('Education Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.educations && comp.educations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
